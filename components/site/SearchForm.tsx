    ...
    return (
        <div>
            ...
            <input 
                ...
                className="w-full p-3 bg-white text-black text-center text-4xl outline-none roundeds-lg disabled:opacity-20"
                autoFocus
                value={cpfInput}
            ...
            className="w-full p-3 mt-3 rounded-lg bg-blue-800 text-white text-4xl border-b-4 border-blue-600 active:border-0 disabled:opacity-20"
                onClick={() => onSearchButton(cpfInput)} disabled={loading}>
